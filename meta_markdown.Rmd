...
Emotional expression enhances both psychological and health-related outcomes [@Rachman1980; @Scheff1979; @Esterling1990; @Fawzy1993; @Lieberman2006]. @Pennebaker1986 first pioneered a form of emotional expression, expressive writing, which involved writing about the thoughts and feelings associated with a "stressful or traumatic" or neutral event. The protocol originally developed by @Pennebaker1986 included 3-5 writing sessions, each lasting 15-20 minutes in length. In their seminal study, @Pennebaker1986 discovered that participants assigned to the stressful/traumatic event condition reported a reduction in health visits after writing about the emotions surrounding the trauma or stressor. Termed written emotional disclosure (WED), this protocol has since been employed across varying contexts. Indeed, as of 2014, the expressive writing literature recognizes over 400 studies across different populations and outcomes [@NilesHaltomMulvennaLiberman2014ADD]. For example, WED is efficacious for health-related outcomes, reducing doctor visits for those diagnosed with Type I diabetes [@Bodor2002] or breast cancer [@Standon2002] and medication use in those suffering from chronic pain [@Smyth1999ADD]. In regards to psychological outcomes, WED is efficacious for reducing depression symptoms [@GortnerRudePennebaker2006ADD], posttraumatic stress [@Blasio2015a], and anxiety [@DeanPottsBarker2016ADD]. For a detailed review of the health-related and psychological benefits of expressive writing, see @SlachterPennebaker289ADD. Whereas emotional expression via expressive writing is efficacious in producing favorable outcomes, a lack of emotional expression is problematic across the aforementioned outcomes and contexts. 

Individuals having experienced a traumatic or stressful life event are more likely to repress thoughts and feelings about their experience compared to individuals who have not experienced such events, thereby subjecting them to potential negative outcomes related to a lack of emotional expression [@Bodor2002]. For example, Posttraumatic Stress Disorder (PTSD) diagnostic criteria are characterized by repeated attempts to cognitively or behaviorally avoid thoughts, feelings, or places related to a given trauma (@ADDCITATION). Avoiding intrusive thoughts or physiological sensations associated with a given trauma or stressor is positively related to various forms of psychopathology, such as depression and trauma-related symptoms [@MarxSloan2005], anxiety [@LevittetalADD], substance use [@Garcia-OliviaPiqueras2016ADD], and social concerns [@Pennebaker1989; @Pennebaker1986]. Admittedly, the hypothetical nature of emotional inhibition makes it difficult to establish a causal relation between inexpression and the aforementioned symptoms. However, inhibiting thoughts or emotions is generally associated with physical and psychological health [@Gross1997; @Goldstein1988; @Larson1990a]. 
