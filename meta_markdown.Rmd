...
We further calculated the overall effect sizes by PTSD diagnosis category. Studies only including individuals with a diagnosis of PTSD exhibited a medium to large effect size (before and after outlier exclusion), while studies not requiring (or listing) a PTSD diagnosis showed a small to medium effect size. Similarly, the mixed category showed a small to medium effect size. Complete estimates are included in Table (LIST OUR SUPER SUPPLEMENTAL TABLE LINK HERE).
