...
We further calculated the overall effect sizes by PTSD diagnosis category. Studies only including individuals with a diagnosis of PTSD exhibited a medium effect size (before and after outlier exclusion): with outliers *d* = `r paste(apa(PTS_yes$TE.random, 2), " [", apa(PTS_yes$lower.random, 2), ", ", apa(PTS_yes$upper.random, 2), "]", sep = "")`; without outliers *d* = `r paste(apa(PTS_yesnoout$TE.random, 2), " [", apa(PTS_yesnoout$lower.random, 2), ", ", apa(PTS_yesnoout$upper.random, 2), "]", sep = "")`, while studies not requiring (or listing) a PTSD diagnosis showed a small to medium effect size: *d* = `r paste(apa(PTS_no$TE.random, 2), " [", apa(PTS_no$lower.random, 2), ", ", apa(PTS_no$upper.random, 2), "]", sep = "")`. Similarly, the mixed category showed a small to medium effect size : *d* = `r paste(apa(PTS_mixed$TE.random, 2), " [", apa(PTS_mixed$lower.random, 2), ", ", apa(PTS_mixed$upper.random, 2), "]", sep = "")`. Complete estimates are included online at https://osf.io/4mjqt/.
